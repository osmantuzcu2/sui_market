      ...
      case "normal":
        return (
          <a
            ...
            className="flex items-center py-2 px-4 rounded-md hover:text-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-800 font-normal text-neutral-6000 dark:text-neutral-400"
          >{item.name}</a>
        )
      default:
        return (
